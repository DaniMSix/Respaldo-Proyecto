...
public class OfertaAcademicaDAO implements IOfertaAcademicaDAO{
    ...
    public ArrayList<OfertaAcademica> obtenerOfertaAcademicaGeneral() {
        ...
        try(Connection connection=dataBaseConnection.getConnection()){
            String query=
                    ("SELECT deep.IdDocenteEEPrograma, ee.Nombre Experiencia, CONCAT_WS(' ', d.Nombre, d.ApellidoPaterno, d.APellidoMaterno) Docente, pe.Nombre Programa FROM docenteseeprogramas deep " +
    ...
    public ArrayList<OfertaAcademica> consultarOfertaAcademicaPorProgramaEducativo(String programaEducativoSeleccionado) {
        ...
        try(Connection connection=dataBaseConnection.getConnection()){
            String query=
                    ("SELECT deep.IdDocenteEEPrograma, ee.Nombre Experiencia, CONCAT_WS(' ', d.Nombre, d.ApellidoPaterno, d.APellidoMaterno) Docente, pe.Nombre Programa " +
